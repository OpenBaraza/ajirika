  ...
  <body class="bg-gray-50 text-gray-800">
    ...
    <section class="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto mb-16 p-6">
      ...
      <div class="bg-white rounded-xl shadow-md p-6">
        ...
        <p>
          Project Ajirika will be <strong>open source</strong>, inviting developers, HR professionals, and designers to continuously evolve the CV standard together.
        </p>
      </div>
    </section>
    ...
    <section class="max-w-5xl mx-auto mb-16 p-6">
      ...
      <div class="relative border-l-4 border-blue-600 ml-4">
        <div class="mb-10 ml-6">
          ...
          <p class="text-gray-700">Initial concept meeting held to explore the idea of a standardized data CV format.</p>
        </div>
        <div class="mb-10 ml-6">
          <div class="absolute w-4 h-4 bg-blue-600 rounded-full -left-2 border-2 border-white"></div>
          <h3 class="text-lg font-semibold">October 2025</h3>
        ...
        <div class="ml-6">
          ...
          <p class="text-gray-700">Research phase to understand global standards and similar projects like JSON Resume and HR Open Standards.</p>
        </div>
      </div>
    </section>
    ...
    <section class="max-w-5xl mx-auto mb-16 p-6 relative">
      ...
      <div class="grid md:grid-cols-2 gap-6 relative z-10">
        <div class="bg-white rounded-xl shadow-lg p-6 text-center relative overflow-hidden border-t-4 border-blue-500">
          <svg class="absolute top-0 left-0 w-full h-full opacity-10 text-blue-300" fill="currentColor" viewBox="0 0 200 200">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 text-center relative overflow-hidden border-t-4 border-green-500">
          <svg class="absolute top-0 right-0 w-full h-full opacity-10 text-green-300" fill="currentColor" viewBox="0 0 200 200">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 text-center relative overflow-hidden border-t-4 border-yellow-500">
          <svg class="absolute bottom-0 left-0 w-full h-full opacity-10 text-yellow-300" fill="currentColor" viewBox="0 0 200 200">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 text-center relative overflow-hidden border-t-4 border-purple-500">
          <svg class="absolute bottom-0 right-0 w-full h-full opacity-10 text-purple-300" fill="currentColor" viewBox="0 0 200 200">
    ...
    <section class="max-w-5xl mx-auto mb-16 p-6">
      ...
      <div class="grid md:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-md p-6 text-center border-t-4 border-yellow-500">
          ...
          <p class="text-gray-700">
            Incorporate <strong>Kenyan education and certification standards</strong> to make the schema locally relevant while maintaining global interoperability.
          </p>
        </div>
      </div>
    </section>
